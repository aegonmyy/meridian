...
///         Path 3) must live inside `_attemptSettleWithdrawal` rather than at the CCIP
///         callback call sites alone, since `attemptSettlement` is external and permissionless.
