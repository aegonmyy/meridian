...
contract AllocationMathsHarness {
    function netApy(uint256 gross, uint256 costs) external pure returns (uint256) {
        return AllocationMaths.netApy(gross, costs);
    }
